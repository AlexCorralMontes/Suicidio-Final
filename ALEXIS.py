...
# your api key (identificador de autenticacion)
...
def listen():
    ...
    try:
        ...
        pass
    return flag
def BioAlexis(comanda):
    """
    talk("Donde quiere que busque")
    comanda = 
    """
def run(rec):
    '''
    ...
    if 'reproduce' in rec:
        ...
        talk(info)
    elif 'bio alexis' in rec:
        ####implementar sonido futurista####
        talk("Accediendo a bio Alexis, espera un momento")
        BioAlexis()
    elif 'exit' in rec:
        flag = 0
        talk("Saliendo...")
